    ...
    <div className="bg-dot-grid min-h-screen pb-24">
      ...
      <section className="relative overflow-hidden pb-10 md:pb-28">
        ...
        <div className="container px-4 md:px-6 relative z-10">
          {/* 返回按钮 */}
          <a href="/knowledge" className="back-btn inline-flex items-center gap-2 mb-4 md:mb-10 text-sm font-semibold text-[var(--foreground)] bg-white px-5 py-2.5 border-2 border-[var(--foreground)] rounded-full">
